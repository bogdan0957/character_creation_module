...
def start_training(char_name:str, char_class:str) -> Character:
    """
    ...
    while cmd in commands:
        selected_commands = input('Введи команду: ')
        training_result: char_class = commands[selected_commands](char_name)
